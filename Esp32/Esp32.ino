...
// ============================================================================
const char* ssid = "asssasas";//
const char* password = "asasasas"; //$Esta es la CL4V3$
const char* aws_api_url = "asas";
const char* user_id = "Diego";

// ✅ FIRESTORE REST API Configuration
const char* FIREBASE_PROJECT_ID = "ssssadasdas-7f9e3";  // Tu ID de proyecto
const char* FIRESTORE_BASE_URL = "asdasdasdasd";

// ⚠️ IMPORTANTE: Necesitas obtener tu API Key de Firebase
// Ve a: Firebase Console → Project Settings → General → Web API Key
const char* FIREBASE_API_KEY = "asdasd-PQC3iasdasdasdasdasdqsd1q-sdas";  // ⚠️ CAMBIAR ESTO
